...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-sm-4 col-sm-offset-4">
            ...
            <div class="row">
                <form class="form-horizontal" method="POST" action="{{ route('item.update', ['id' => $data->id]) }}">
                    {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control" type="text" name="item_code"
                                   value="{{ old('item_code')?old('item_code'):$data->item_code }}" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input class="form-control" type="text" name="item_name"
                                   value="{{ old('item_name')?old('item_name'):$data->item_name }}">
